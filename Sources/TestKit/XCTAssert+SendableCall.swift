...
public func XCTAssertMethodWasCalled<P, R>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
...
public func XCTAssertMethodWasNotCalled<P, R>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
                                              _ message: @autoclosure () -> String = "",
                                              file: StaticString = #filePath,
                                              line: UInt = #line) {
...
public func XCTAssertMethodWasCalledWithArgEquals<P, R>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
                                                        _ arg: @autoclosure @Sendable () -> P,
                                                        _ message: @autoclosure () -> String = "",
                                                        file: StaticString = #filePath,
...
public func XCTAssertMethodWasCalledWithArgEquals<P, R, T: Sendable>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
                                                           _ keyPath: KeyPath<P, T> & Sendable,
                                                           _ arg: @autoclosure @Sendable () -> T,
                                                           _ message: @autoclosure () -> String = "",
                                                        file: StaticString = #filePath,
...
public func XCTAssertMethodWasCalledLastWithArgEquals<P, R>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
                                                            _ arg: @autoclosure () -> P,
                                                            _ message: @autoclosure () -> String = "",
                                                            file: StaticString = #filePath,
                                                            line: UInt = #line) where P: Equatable {
...
public func XCTAssertMethodWasCalledLastWithArgEquals<P, R, T>(_ methodCall: @autoclosure () -> SendableMethodCall<P, R>,
